...
void test07_1(){
    ...
    s1.insert(5); //关联式容器 key进行排序，从小到大
    s1.insert(1);
    s1.insert(9);
    s1.insert(3);
    s1.insert(7);
...
void test07_2(){
    ...
    if (it!= s1.end()){
        cout << "找到了 lower_bound (3)的值为：" << *it << endl; // 找到了 lower_bound (3)的值为：3
    }
    else{
        cout << "未找到" << endl;
    }
    ...
    if (it2 != s1.end()){
        cout << "找到了 upper_bound (3)的值为：" << *it2 << endl; //找到了 upper_bound (3)的值为：5
    }
    else{
        cout << "未找到" << endl;
    }
    ...
    //获取第一个值
    if (ret.first != s1.end()){
        cout << "找到equal_range中 lower_bound 的值 ：" << *(ret.first) << endl; // 找到equal_range中 lower_bound 的值 ：3
    }
    else{
        cout << "未找到" << endl;
    }
    ...
    if (ret.second != s1.end()){
        cout << "找到equal_range中 upper_bound 的值 ：" << *(ret.second) << endl; //找到equal_range中 upper_bound 的值 ：5
    }
    else{
        cout << "未找到" << endl;
    }
