...
void test06_2(){
    ...
    printList(L); // 10 10 10 10 10 10 10 10 10 10
    printList(L2); // 10 10 10 10 10 10 10 10 10 10
    L2.push_back(100);
    ...
    cout << endl; // 100 10 10 10 10 10 10 10 10 10 10
...
void test06_3(){
    ...
    //200 300 100
    cout << "front: " << L4.front() << endl; // front: 200
    cout << "back: " << L4.back() << endl; // back: 100
}
...
//Person排序规则 如果年龄 相同  按照身高的升序排序 (高级排序 )
...
void test06_5(){
    ...
    //删除 狗蛋
    cout << " -------------------- " << endl;
    L.remove(p6); // 删除自定义类型  要 重载 == 让remove 可以删除自定义的person类型
    for (list<Person>::iterator it = L.begin(); it != L.end(); it++){
        cout << "姓名： " << it->m_Name << " 年龄： " << it->m_Age << " 身高：" << it->m_Height << endl;
    }
}
